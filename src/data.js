...
export const competitions = {
  ...
  ranked: [
    ...
    { slug: 'hedge-fund-time-series', name: 'Hedge fund time series forecasting', host: 'Kaggle', rank: 15, of: 983, short: 'KAGGLE TS',
    ...
    { slug: 'murex-cmf-brainteasers', name: 'Murex x CMF brainteasers', host: 'Murex, CMF', rank: 5, of: 150, short: 'MUREX CMF',
